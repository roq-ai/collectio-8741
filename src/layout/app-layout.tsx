...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'finance-manager', 'end-customer', 'vendor'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Finances', path: '/finances', entity: 'finance', service: AccessServiceEnum.PROJECT, icon: FiBarChart2 },
    { name: 'Payments', path: '/payments', entity: 'payment', service: AccessServiceEnum.PROJECT, icon: FiCreditCard },
    { name: 'Vendors', path: '/vendors', entity: 'vendor', service: AccessServiceEnum.PROJECT, icon: FiTruck },
