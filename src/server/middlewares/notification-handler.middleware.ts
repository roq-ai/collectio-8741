...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Order Placed.create': {
    roles: ['business-owner', 'finance-manager', 'end-customer', 'vendor'],
    key: 'order_placed',
    tenantPath: [],
    userPath: [],
  },
  'Payment Received.create': {
    roles: ['business-owner', 'finance-manager'],
    key: 'payment_received',
    tenantPath: [],
    userPath: [],
  },
  'Delivery Status Updated.update': {
    roles: ['business-owner', 'end-customer'],
...
const tenantRoles: string[] = ['business-owner', 'finance-manager', 'end-customer', 'vendor'];
